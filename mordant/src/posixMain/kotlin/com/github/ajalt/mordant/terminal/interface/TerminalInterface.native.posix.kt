...
internal expect fun getStdinTermiosNative(): TerminalInterfacePosix.Termios
internal expect fun setStdinTermiosNative(termios: TerminalInterfacePosix.Termios)

internal object SyscallHandlerNativePosix : TerminalInterfacePosix() {
