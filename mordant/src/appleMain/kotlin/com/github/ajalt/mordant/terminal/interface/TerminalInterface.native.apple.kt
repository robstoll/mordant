...
import com.github.ajalt.mordant.terminal.`interface`.TerminalInterfacePosix.Termios
...
internal actual fun getStdinTermiosNative(): Termios = memScoped {
...
internal actual fun setStdinTermiosNative(termios: Termios): Unit = memScoped {
